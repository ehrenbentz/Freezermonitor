...
def check_blinka_python_version():
    ...
    current_major, current_minor = map(int, current.split(".")[0:2])
    required_major, required_minor = map(int, str(blinka_minimum_python_version).split(".")[0:2])  # Convert to integers
